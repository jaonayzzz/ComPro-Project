...
void drawShop(){
        ...
        // --- ส่วนการวาด Grid สี่เหลี่ยมขอบมน ---
        int rows = 6;            
        int columns = 6;         
        ...
        // 1. คำนวณพิกัดล่างขวา (ใช้สูตรเดียวกับปุ่ม Next เพื่อให้ตำแหน่งตรงกันเป๊ะ)
        ...
        // 2. ตั้งค่าตำแหน่ง (อ้างอิงภายใน Window)
        ImGui::SetCursorPos(ImVec2(windowW - btnW - paddingX, windowH - btnH - paddingY));

        // 3. วาดปุ่ม Back พร้อมสไตล์
